...
<div style = "margin:0 ; position:absolute; top:435 ; left:20">
<b><u>STATUS:</u></b><h3 id="status" Style="color:green ; font-family:Arial ; text-align:center">I AM USING FREEDOM</h3>
<hr>
<h4><b>HOME THEME</b></h4>
<form id="uploadform" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post" enctype="multipart/form-data">
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp  <input type="file" class="file_up" name="file_up[]" /><br />
 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp  &nbsp <input type="submit" value="SET" id="submit" />
</form>
</div>
...
<a href="like.php"><img src="like.png" style="margin:0 ; position:absolute; top:380 ; left:-320 ; height:35 ; width:35"/></a>
...
<form name="pro" action="home1.php" method="post">
<table>
<tr>Full Name:
...
<tr>
Status:<br>
<textarea name="status" rows="2" cols="40" value="" style="font-size:20 ; font-style:bold">
</textarea>
</tr><br/><br/>
...
$updir = 'database/theme';     // sets the folder
